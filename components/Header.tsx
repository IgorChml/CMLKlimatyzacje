  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden lg:flex items-center gap-3">
              <a
                href="tel:691959013"
                className="flex items-center gap-2 font-bold text-orange hover:text-orange/80 transition-colors text-sm min-h-[44px] px-2"
                aria-label="Zadzwoń 691 959 013"
              >
                <Phone className="w-4 h-4" strokeWidth={2.5} />
                691 959 013
              </a>
              <a href="tel:691959013" className="btn-primary text-sm py-2 px-4 min-h-[44px]">
                Zadzwoń teraz
              </a>
            </div>
        ...
        {menuOpen && (
          <div className="lg:hidden bg-navy border-t border-white/10">
            <nav className="max-w-7xl mx-auto px-4 py-4 flex flex-col gap-1" aria-label="Menu mobilne">
              ...
              <div>
                <button
                  className="w-full flex items-center justify-between px-4 py-3 rounded-lg text-sm font-medium hover:bg-sky/20 hover:text-sky transition-all duration-300 min-h-[44px]"
                  ...
                  <div className="ml-4 mt-1 mb-1 flex flex-col gap-0.5 border-l-2 border-sky/30 pl-3">
                    {klimatyzacjeItems.map((item) => (
                      <Link
                        key={item.href}
                        href={item.href}
                        className="px-3 py-2.5 rounded-lg text-sm font-medium text-gray-300 hover:text-sky hover:bg-sky/10 transition-all duration-300 min-h-[44px] flex items-center"
              ...
              {navLinks.map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
                  className="px-4 py-3 rounded-lg text-sm font-medium hover:bg-sky/20 hover:text-sky transition-all duration-300 min-h-[44px] flex items-center"
                  onClick={() => setMenuOpen(false)}
                >
                  {link.label}
                </Link>
              ...
              <a
                href="tel:691959013"
                className="mt-2 flex items-center justify-center gap-2 font-bold text-orange px-4 py-3 rounded-lg hover:bg-white/10 transition-colors min-h-[44px]"
              >
                <Phone className="w-4 h-4" strokeWidth={2.5} />
                691 959 013
              </a>
      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 z-50 safe-bottom">
        <a
          href="tel:691959013"
          className="flex items-center justify-center gap-2 bg-orange text-white font-bold text-base w-full min-h-[44px] py-3 shadow-lg"
          aria-label="Zadzwoń 691 959 013"
        >
